        ...
        return (
            <form style={{ width: "65%", margin: "auto" }}>
                ...
                <div style={{ textAlign: "center", justifyContent: "center", margin: "auto" }}>
                    <input type="button" className="btn btn-primary" value="Update Event" onClick={() => { this.update() }} />
                    <input type="button" className="btn btn-primary" value="Delete Event" onClick={() => { this.delete() }} />
                </div>
            </form>
        )
    }
...
export default connect(mapStateToProps, { updateEvent, deleteEvent })(UpdateEvent);